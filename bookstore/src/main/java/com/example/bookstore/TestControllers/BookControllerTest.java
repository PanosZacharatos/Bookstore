...
public class BookControllerTest {
    ...
    public void testGetAllBooks() throws Exception {
        // creatin page of books
        Page<Book> bookPage = new PageImpl<>(Arrays.asList(
        ...
        // mock
        when(bookService.findAllBooks(PageRequest.of(0, 10))).thenReturn(bookPage);

        // get request and assert status is ok
    ...
    public void testGetAllBooks_NoResults() throws Exception{
        ...
        Page<Book> emptyBook = new PageImpl<>(Collections.emptyList());
        //set up mock service
        when(bookService.findAllBooks(PageRequest.of(0,10))).thenReturn(emptyBook);
    ...
    public void testGetAllBooks_ServiceException() throws Exception{
        //set up mock service
        when(bookService.findAllBooks(org.mockito.Mockito.any(Pageable.class))).thenThrow(new RuntimeException("Failed to retrieve books"));
    ...
    public void testGetAllBooks_DataIntegrity() throws Exception{
        ...
        //set up mock service
        when(bookService.findAllBooks(org.mockito.Mockito.any(Pageable.class)))
